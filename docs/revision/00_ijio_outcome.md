# R0 — IJIO Submission Outcome Freeze

## Verdict

**R0 COMPLETE WITH ONE ARTIFACT-PROVENANCE LIMITATION**
...
- Editorial decision date: **2026-09-21** (author-provided decision email)
- External review: **not initiated**
- Handling editor identified in decision: **Sandro Shelegia**

## Sanitized editorial decision record

The full editorial email is not committed to this public repository. Account-support links, privacy-operation links, routing codes, and other non-research boilerplate are excluded.

The research-relevant editorial assessment was:

- the manuscript was regarded as generally clear and well written;
- the editor decided not to send it for external review;
- the central concern was insufficient innovation/general scientific insight for IJIO;
- the analysis was viewed as a fairly standard three-country Cournot trade exercise;
- compatibility and coalition conclusions were seen as arising from comparisons among configurations of the same linear Cournot subgames;
- the editor did not see enough of a mechanism that readers could carry to other settings;
- the letter advised submission elsewhere and did not invite revision/resubmission to IJIO.

This is a contribution/generality judgment, not a certification of mathematical correctness and not a referee report.

## Repository state and submission-source identification
...
## Manuscript-PDF cross-check

The final 84-page Editorial Manager PDF preserved outside GitHub contains:

- page 1: Editorial Manager metadata sheet;
- pages 2–74: the 73-page manuscript;
- pages 75–82: supplementary-code link sheets;
- page 83: LaTeX-source link sheet;
- page 84: declaration-of-interests sheet.

The manuscript portion (pages 2–74) was text-normalized and compared against the repository-generated identified manuscript PDF. After removing the single Editorial Manager link boilerplate line, normalized text matched exactly:

- normalized length: 132,147 characters on each side;
- sequence comparison ratio: 1.0;
- normalized-text equality: TRUE.

This verifies substantive manuscript-content identity, not PDF binary identity.
...
R1 must not infer that the editor validated the mathematics.
